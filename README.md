...
```
cd existing_repo
git remote add origin https://gitlab.com/morrismotel-team/morrismotel-blog.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/morrismotel-team/morrismotel-blog/-/settings/integrations)
